...
import com.xinyuan.xyshop.adapter.EmotionGridViewAdapter;
import com.xinyuan.xyshop.adapter.EmotionPagerAdapter;
import com.xinyuan.xyshop.base.BaseFragment;
import com.xinyuan.xyshop.base.BasePresenter;
import com.xinyuan.xyshop.util.EmotionUtils;
import com.xinyuan.xyshop.util.GlobalOnItemClickManagerUtils;
import com.xinyuan.xyshop.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment<BasePresenter> {
	...
	private void initEmotion() {
		...
		// item的间距
		int spacing = XDensityUtils.dp2px(12);
		// 动态计算item的宽度和高度
