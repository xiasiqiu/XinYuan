...
//		showState(0);
//		context = SearchGoodsShowActivitys.this;
...
//				CommUtil.gotoActivity(SearchGoodsShowActivitys.this, GoodDetailsActivity.class, false, null);
//			}
//		});
//	}
//
...
//
//		showState(1);
//		this.selectFilterTest = selectFilterTest;
//		menuHeaderView = new RightSearchPly(SearchGoodsShowActivitys.this, selectFilterTest);
...
//						SearchGoodsShowActivitys.this.popSort.dismiss();
//					}
//					return false;
//				}
//			});
...
//					if (SearchGoodsShowActivitys.this.btnSortDefault.isSelected()) {
//						SearchGoodsShowActivitys.this.popSort.dismiss();
//						return;
//					}
//					SearchGoodsShowActivitys.this.btnSortDefault.setSelected(true);
//					SearchGoodsShowActivitys.this.btnSortHon.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSortPriceL.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSortPriceU.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSort.setText("综合排序");
//					SearchGoodsShowActivitys.this.sortSelected(true, false, "", false);
//					SearchGoodsShowActivitys.this.sort = "";
//					SearchGoodsShowActivitys.this.page = 1;
//					presenter.initData(keyword, brandId, cat, sort, selectValue, page);
//					SearchGoodsShowActivitys.this.popSort.dismiss();
//				}
//			});
...
//						return;
//					}
//					SearchGoodsShowActivitys.this.btnSortDefault.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSortHon.setSelected(true);
//					SearchGoodsShowActivitys.this.btnSortPriceL.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSortPriceU.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSort.setText("信用排序");
//					SearchGoodsShowActivitys.this.sortSelected(true, false, "", false);
//					SearchGoodsShowActivitys.this.sort = "";
//					SearchGoodsShowActivitys.this.page = 1;
//					presenter.initData(keyword, brandId, cat, sort, selectValue, page);
...
//				public void onClick(View view) {
//					if (SearchGoodsShowActivitys.this.btnSortPriceL.isSelected()) {
//						SearchGoodsShowActivitys.this.popSort.dismiss();
//						return;
//					}
//					SearchGoodsShowActivitys.this.btnSortDefault.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSortHon.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSortPriceL.setSelected(true);
//					SearchGoodsShowActivitys.this.btnSortPriceU.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSort.setText("价格从低到高");
//					SearchGoodsShowActivitys.this.sortSelected(true, false, "price_desc", false);
//					SearchGoodsShowActivitys.this.page = 1;
//					presenter.initData(keyword, brandId, cat, sort, selectValue, page);
//					SearchGoodsShowActivitys.this.popSort.dismiss();
//				}
...
//				public void onClick(View view) {
//					if (SearchGoodsShowActivitys.this.btnSortPriceU.isSelected()) {
//						SearchGoodsShowActivitys.this.popSort.dismiss();
//						return;
//					}
//					SearchGoodsShowActivitys.this.btnSortDefault.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSortHon.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSortPriceL.setSelected(false);
//					SearchGoodsShowActivitys.this.btnSortPriceU.setSelected(true);
//					SearchGoodsShowActivitys.this.btnSort.setText("价格从高到低");
//					SearchGoodsShowActivitys.this.sortSelected(true, false, "price_asc", false);
//					SearchGoodsShowActivitys.this.page = 1;
//					presenter.initData(keyword, brandId, cat, sort, selectValue, page);
//					SearchGoodsShowActivitys.this.popSort.dismiss();
//
