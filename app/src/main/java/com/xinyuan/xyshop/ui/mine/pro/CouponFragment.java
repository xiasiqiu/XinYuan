...
public class CouponFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initView(View rootView) {
        ...
        tv_header_center.setText("我的优惠券");
        ...
        rv_coupon.addItemDecoration(new RecycleViewDivider(mContext, LinearLayoutManager.VERTICAL));
    ...
    private void getData(int ship) {
        OkGo.<LzyResponse<List<CouponBean>>>post(Urls.URL_USER_COUPON)
                .tag(this)
