package com.xinyuan.xyshop.widget.dialog.color;
...
public class PromptDialog extends Dialog {
	...
	private void initView() {
		...
		triangleIv.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, XDensityUtils.dp2px(10)));
		triangleIv.setImageBitmap(createTriangel((int) (CommUtil.getScreenSize(getContext()).x * 0.7), XDensityUtils.dp2px(10)));
		...
		int radius = XDensityUtils.dp2px(DEFAULT_RADIUS);
	...
	private void resizeDialog() {
		...
		params.width = (int) (CommUtil.getScreenSize(getContext()).x * 0.7);
	...
	private void setBtnBackground(final TextView btnOk) {
		btnOk.setTextColor(createColorStateList(getContext().getResources().getColor(getColorResId(mDialogType)),
				getContext().getResources().getColor(R.color.bg_gray)));
