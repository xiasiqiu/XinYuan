...
public class BottomBarTab extends FrameLayout {
	...
	private void init(Context context, int icon, CharSequence title) {
		...
		mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tv_name));
		...
		mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.tv_name));
	...
	public void setSelected(boolean selected) {
		...
		if (selected) {
			...
			mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.tv_name));
			mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.tv_name));
		}
	}
