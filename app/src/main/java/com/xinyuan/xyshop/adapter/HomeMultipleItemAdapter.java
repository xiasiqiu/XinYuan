...
import com.xinyuan.xyshop.ui.home.HomeDataLoadHelper;
import com.xinyuan.xyshop.ui.home.HomeShowViewHelper;
...
public class HomeMultipleItemAdapter extends BaseMultiItemQuickAdapter<HomeMultipleItem, BaseViewHolder> {
    ...
    private HomeShowViewHelper showViewHelper;
    ...
    public HomeMultipleItemAdapter(Context context, List data) {
        ...
        goodsList = HomeDataLoadHelper.getItemGoodsList();
        tabTitleList = HomeDataLoadHelper.getItemTabTitleList();
        categoryList = HomeDataLoadHelper.getCategoryList();
        tablist = HomeDataLoadHelper.getTabList();
        adList = HomeDataLoadHelper.getItemADList();
